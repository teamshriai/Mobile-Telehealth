...
const TEMPLATES: Array<{
  ...
  { key: 'OS.SEPSIS-ADULT', name: 'Adult sepsis — initial management', category: 'OrderSet', scope: TemplateScope.Facility, reviewDueDays: 120,
  ...
  { key: 'OS.STROKE-THROMBOLYSIS', name: 'Stroke — thrombolysis workup', category: 'OrderSet', scope: TemplateScope.Facility, reviewDueDays: 90,
