/**
 * Mock patient data for OncoTrace AI
 * Primary patient: Anand Krishnamurthy
 */
...
export const mockPatient = {
  ...
  biomarkers: [
    { name: 'EGFR',    status: 'Mutated',   variant: 'Exon 19 deletion', significance: 'Targetable' },
    { name: 'ALK',     status: 'Negative',  variant: null,              significance: 'Wildtype' },
    { name: 'PD-L1',   status: 'Positive',  variant: 'TPS 65%',         significance: 'High expression' },
    { name: 'KRAS',    status: 'Negative',  variant: null,              significance: 'Wildtype' },
    { name: 'ROS1',    status: 'Negative',  variant: null,              significance: 'Wildtype' },
    { name: 'MET',     status: 'Amplified', variant: 'MET Exon 14',     significance: 'Targetable' },
    { name: 'TP53',    status: 'Mutated',   variant: 'R248W',           significance: 'Co-mutation' },
    { name: 'BRAF',    status: 'Negative',  variant: null,              significance: 'Wildtype' },
  ],
  ...
  allergies: [
    ...
    { substance: 'Sulfonamides', reaction: 'Hypersensitivity', severity: 'Mild' },
  ],

  medications: [
    { name: 'Osimertinib', dose: '80mg', frequency: 'Once daily', since: '2023-11-01' },
    { name: 'Ondansetron', dose: '8mg',  frequency: 'As needed',  since: '2023-11-01' },
    { name: 'Pantoprazole',dose: '40mg', frequency: 'Once daily', since: '2023-11-01' },
    { name: 'Vitamin D3',  dose: '2000 IU', frequency: 'Once daily', since: '2024-01-10' },
  ],
}
