...
import { portalForRole, titleForPath } from '../../app/navigation.js'
import { useAuth } from '../../app/AuthContext.jsx'
import { useIdleTimeout } from '../../app/useIdleTimeout.js'
import { useDismissable } from '../../app/useDismissable.js'
...
function navItemClass(isActive, tone) {
  const base =
...
function NavDrawer({ open, onClose, portal, role }) {
