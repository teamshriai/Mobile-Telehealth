...
export default function ForgotPassword() {
  ...
  /* Basic email regex — same pattern as Register.tsx */
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
       ...
       */
      if (apiErr.status === 404 || apiErr.status === 400 || apiErr.status === 429) {
                    ...
                    <motion.div custom={0} variants={fadeIn} initial="initial" animate="animate">
                      ...
                      <div className="relative group">
                        ...
                        <input
                          ...
                          name="email"
                          value={email}
                          onChange={(e: ChangeEvent<HTMLInputElement>) => { setEmail(e.target.value); if (error) setError('') }}
                          autoComplete="email"
