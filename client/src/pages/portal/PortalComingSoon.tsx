...
import { Stethoscope, ShieldCheck, HeartPulse, FlaskConical, LogOut, ArrowLeft, type LucideIcon } from 'lucide-react'
 ...
 * `portal="Doctor"` prop set on the route element in App.tsx, regardless of
...
const PORTALS: Partial<Record<RoleName, PortalConfig>> = {
  Doctor: {
    icon: Stethoscope,
    name: 'Doctor Portal',
    blurb:
...
export default function PortalComingSoon() {
  ...
  const config = (role ? PORTALS[role as RoleName] : undefined) ?? PORTALS.Doctor!
